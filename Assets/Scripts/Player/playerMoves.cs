...
public class playerMoves : MonoBehaviour
{
    ...
    public void Move(InputAction.CallbackContext context)
    {
        ...
        if (isTouchingBlocks && !isClimbing && !isjumping && context.performed)
        {
    ...
    public void physicsCheck()
    {
        ...
        RaycastHit2D hit = Physics2D.Raycast(transform.position, raycastDirection, raycastLength, LayerMask.GetMask("Blocks"));
        ...
        RaycastHit2D hit1 = Physics2D.Raycast(eyePosition, raycastDirection1, raycastLength, LayerMask.GetMask("Blocks"));
        Color rayColor1 = Color.red;
        if (hit.collider != null && hit1.collider.gameObject.layer == LayerMask.NameToLayer("Blocks"))
        {
